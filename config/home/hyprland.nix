...
#        }
      ...
      #My binds
      bind=CTRL,tab,hycov:toggleoverview
      ...
      # Screenshot a window
      bind = ${modifier}SHIFT, PRINT, exec, hyprshot -m window
      # Screenshot a monitor
      bind = , PRINT, exec, hyprshot -m output
      # Screenshot a region
      bind = ${modifier}, PRINT, exec, hyprshot -m region

      $pavucontrol = class:^(pavucontrol)$
      windowrulev2 = float,$pavucontrol
      windowrulev2 = size 50% 40%,$pavucontrol
      windowrulev2 = move 49.5% 3%,$pavucontrol
      #windowrulev2 = workspace special silent,$pavucontrol
      windowrulev2 = opacity 0.80,$pavucontrol


      bind = ${modifier},Return,exec,kitty
      bind = ${modifier},code:47,exec,rofi -show drun

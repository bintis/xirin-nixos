...
let
  ...
  case "$2" in
      "system")
        echo "Usage: phoenix sync system [verbose]"
        echo "Sync the system configuration."
        echo "Options:"
        echo "  verbose   Show stack traces and detailed output."
        ;;
      "user")
        echo "Usage: phoenix sync user [verbose]"
        echo "Sync the user configuration."
        echo "Options:"
        echo "  verbose   Show stack traces and detailed output."
        ;;
      *)
        echo "Usage: phoenix sync [system|user] [verbose]"
        echo "Sync the system or user configuration."
        echo "Options:"
        echo "  system    Sync the system configuration."
        echo "  user      Sync the user configuration."
        echo "  verbose   Show stack traces and detailed output."
        ;;
    esac
    ;;
  "update")
    echo "Usage: phoenix update [verbose]"
    echo "Update the flake inputs and other package managers."
    echo "Options:"
    echo "  verbose   Show detailed output."
    ;;
  "gc")
    echo "Usage: phoenix gc [full|<age>] [verbose]"
    echo "Perform garbage collection."
    echo "Options:"
    echo "  full      Perform full garbage collection."
    echo "  <age>     Perform garbage collection for items older than <age> (e.g., '30d' for 30 days)."
    echo "  verbose   Show detailed output."
    ;;
  *)
    echo "Usage: phoenix <command>"
    echo "Commands:"
    echo "  sync     Sync configurations"
    echo "  update   Update flake and package managers"
...
in
{
  home.packages = [
    ...
    (pkgs.writeScriptBin "roon-tui" ./roon-tui)
  ];
}
